namespace StudioLaValse.ScoreDocument.Builder
{
    ...
    public interface IScoreBuilder
    {
        ...
        /// <param name="action"></param>
        /// <returns></returns>
        IScoreBuilder Edit(Action<IScoreDocumentEditor, IScoreLayoutBuilder> action);
        ...
        /// <param name="action"></param>
        /// <returns></returns>
        IScoreBuilder Edit<TElement>(IEnumerable<int> elementIds, Action<TElement, IScoreLayoutBuilder> action) where TElement : IScoreElementEditor;
