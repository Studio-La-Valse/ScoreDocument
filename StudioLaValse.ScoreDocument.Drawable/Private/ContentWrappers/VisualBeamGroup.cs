...
namespace StudioLaValse.ScoreDocument.Drawable.Private.ContentWrappers
{
    internal sealed class VisualBeamGroup : BaseContentWrapper
    {
        ...
        public VisualBeamGroup(VisualStem[] visualStems, Ruler visualBeamDefinition, double beamThickness, double beamSpacing, double scale, IVisualBeamBuilder visualBeamBuilder)
        {
        ...
        {
            return visualBeamBuilder.Build(visualStems, visualBeamDefinition, beamThickness, beamSpacing, scale);
        }
    }
}
