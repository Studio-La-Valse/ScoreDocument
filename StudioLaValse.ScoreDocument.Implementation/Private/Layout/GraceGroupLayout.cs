...
{
    internal abstract class GraceGroupLayout : IGraceGroupLayout
    {
    ...
    internal class AuthorGraceGroupLayout : GraceGroupLayout
    {
    ...
    internal class UserGraceGroupLayout : GraceGroupLayout
    {
