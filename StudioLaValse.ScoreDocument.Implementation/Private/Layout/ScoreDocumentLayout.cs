...
{
    internal abstract class ScoreDocumentLayout : IScoreDocumentLayout
    {
    ...
    internal class AuthorScoreDocumentLayout : ScoreDocumentLayout
    {
    ...
    internal class UserScoreDocumentLayout : ScoreDocumentLayout
    {
        public Guid Id { get; }
