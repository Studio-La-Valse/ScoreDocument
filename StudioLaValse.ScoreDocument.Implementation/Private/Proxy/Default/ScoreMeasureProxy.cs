...
internal class ScoreMeasureProxy(ScoreMeasure source, ILayoutSelector layoutSelector) : IScoreMeasure
{
    ...
    public TemplateProperty<KeySignature> KeySignature => Layout.KeySignature;
    ...
    {
        return source.GetMeasureCore(ribbonIndex).Proxy(layoutSelector);
    }
