...
namespace StudioLaValse.ScoreDocument.Models.V1.StyleTemplates
{
    /// <summary>
    ...
    public class PageStyleTemplate
    {
        ...
        public static PageStyleTemplate Create()
        {
            return new PageStyleTemplate()
            {
                ...
                MarginLeft = 15,
                MarginBottom = 15,
                PageColor = new ColorARGBClass() { A = 255, R = 214, G = 187, B = 137 },
                ForegroundColor = new ColorARGBClass() { A = 255, R = 18, G = 79, B = 89 }
            };
        }
