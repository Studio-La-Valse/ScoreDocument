...
namespace StudioLaValse.ScoreDocument.Reader.Extensions
{
    public static class ChordExtensions
    {
        ...
        public static Dictionary<Position, (double position, double spaceRight)> EnumeratePositions(this IScoreMeasureReader scoreMeasureReader, double scoreScale)
        {
        ...
        /// </summary>
        public static double ApproximateWidth(this IScoreMeasureReader scoreMeasure, double scoreScale)
        {
